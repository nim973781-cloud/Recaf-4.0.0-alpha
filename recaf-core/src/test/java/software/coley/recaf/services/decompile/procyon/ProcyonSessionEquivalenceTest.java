...
/**
 * Equivalence gates for {@link ProcyonSessionFactory}.
 */
class ProcyonSessionEquivalenceTest extends TestBase {
	...
	static ProcyonSessionFactory factory;
	...
	static void setup() throws IOException {
		factory = recaf.get(ProcyonSessionFactory.class);
		singleDecompiler = recaf.get(DecompilerManager.class).getJvmDecompiler(ProcyonDecompiler.NAME);
		assertNotNull(singleDecompiler, "Procyon decompiler was never registered with manager");
