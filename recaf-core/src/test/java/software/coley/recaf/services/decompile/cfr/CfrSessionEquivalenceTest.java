...
/**
 * Equivalence gates for {@link CfrSessionFactory}.
 */
class CfrSessionEquivalenceTest extends TestBase {
	...
	static CfrSessionFactory factory;
	...
	static void setup() throws IOException {
		factory = recaf.get(CfrSessionFactory.class);
		singleDecompiler = recaf.get(DecompilerManager.class).getJvmDecompiler(CfrDecompiler.NAME);
		assertNotNull(singleDecompiler, "CFR decompiler was never registered with manager");
