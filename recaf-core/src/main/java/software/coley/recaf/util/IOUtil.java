...
public final class IOUtil {
	...
	public static String getExtensionFromFileInfo(@Nullable FileInfo file) {
		return switch (file) {
			case ApkFileInfo ignored -> "apk";
			case ArscFileInfo ignored -> "arsc";
			case BinaryXmlFileInfo ignored -> "xml";
			case DexFileInfo ignored -> "dex";
			case JarFileInfo ignored -> "jar";
			case JModFileInfo ignored -> "jmod";
			case WarFileInfo ignored -> "war";
			case ZipFileInfo ignored -> "zip";
