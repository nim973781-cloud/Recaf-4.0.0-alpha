 ...
 * bound to one format config and is safe for concurrent readers and writers, so the engine can print
 * classes of one session in parallel.
 *
 * @author Matt Coley
...
public class TypeNameCache {
	private final Map<String, Type> methodTypes = new ConcurrentHashMap<>();
	private final Map<String, String> filteredFieldNames = new ConcurrentHashMap<>();
	private final Map<String, String> escapedTypeNames = new ConcurrentHashMap<>();
