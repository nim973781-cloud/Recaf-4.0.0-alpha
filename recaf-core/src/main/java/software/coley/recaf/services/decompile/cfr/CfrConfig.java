...
public class CfrConfig extends BaseDecompilerConfig {
	...
	private final ObservableObject<BooleanOption> ignoreexceptionsalways = new ObservableObject<>(BooleanOption.TRUE);
	private final ObservableObject<BooleanOption> antiobf = new ObservableObject<>(BooleanOption.TRUE);
	private final ObservableObject<BooleanOption> obfcontrol = new ObservableObject<>(BooleanOption.TRUE);
	private final ObservableObject<BooleanOption> obfattr = new ObservableObject<>(BooleanOption.TRUE);
	private final ObservableObject<BooleanOption> constobf = new ObservableObject<>(BooleanOption.TRUE);
	private final ObservableObject<BooleanOption> hidebridgemethods = new ObservableObject<>(BooleanOption.DEFAULT);
	private final ObservableObject<BooleanOption> ignoreexceptions = new ObservableObject<>(BooleanOption.TRUE);
	...
	private final ObservableObject<BooleanOption> recover = new ObservableObject<>(BooleanOption.TRUE);
	...
	private final ObservableObject<BooleanOption> renameillegalidents = new ObservableObject<>(BooleanOption.TRUE);
