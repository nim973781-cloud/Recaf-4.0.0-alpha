...
import software.coley.recaf.ui.control.popup.BatchDecompileJarsPopup;
...
public class FileMenu extends WorkspaceAwareMenu {
	...
	private final Instance<DecompileAllPopup> decompileAllPopupProvider;
	private final Instance<BatchDecompileJarsPopup> batchDecompileJarsPopupProvider;
	...
	public FileMenu(@Nonnull WorkspaceManager workspaceManager,
	                ...
	                @Nonnull Instance<DecompileAllPopup> decompileAllPopupProvider,
	                @Nonnull Instance<BatchDecompileJarsPopup> batchDecompileJarsPopupProvider,
		...
		this.decompileAllPopupProvider = decompileAllPopupProvider;
		this.batchDecompileJarsPopupProvider = batchDecompileJarsPopupProvider;
		...
		MenuItem itemExportDecompiled = action("menu.file.export.decompiled", CarbonIcons.DOCUMENT_EXPORT, this::exportDecompiled);
		MenuItem itemExportDecompiledBatch = action("menu.file.export.decompiled.batch", CarbonIcons.FOLDER, this::exportDecompiledBatch);
		...
		itemExportDecompiled.disableProperty().bind(hasWorkspace.not());
		...
		items.add(itemExportDecompiled);
		items.add(itemExportDecompiledBatch);
	...
	/**
	 * Display the decompile export popup.
	 */
	private void exportDecompiled() {
		DecompileAllPopup popup = decompileAllPopupProvider.get();
		popup.show();
	}

	/**
	 * Display the batch decompile export popup.
	 */
	private void exportDecompiledBatch() {
		BatchDecompileJarsPopup popup = batchDecompileJarsPopupProvider.get();
		popup.show();
	}
